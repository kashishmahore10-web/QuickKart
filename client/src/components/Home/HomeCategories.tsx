  ...
  return (
    <section className='py-16'>
        <div className='max-w-7xl mx-auto'>
            <div>
                <h2 className='text-3xl font-semibold '>Brose Categories</h2>
                <p  className='text-sm text-app-text-light mt-1'>Find exactly what 
                    you need using</p>
            </div>
            <div className='flex items-center mt-8 overflow-x-scroll no-scrollbar'>
                {categoriesData.map((cat: { slug: string; name: string; image: string })=>(
